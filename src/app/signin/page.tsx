      ...
      <div className="flex flex-col items-center border border-stone-700">
        <div className="flex flex-col border-stone-700 bg-black rounded-2xl justify-between p-5 w-80">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Button onClick={handleSignin} className="bg-blue-600 mt-2">
              Login
            </Button>
            <div className="flex flex-col  gap-2 justify-center items-center">
              <Button className=" text-blue-600  bg-black hover:bg-black text-[15px] ">
                <img
            ...
            <div className="flex justify-center gap-x-1">
              ...
              <Link
                href="/signup"
                className="text-[10px] text-blue-600 hover:text-white hover:underline"
              >
                Sign up
              </Link>
            </div>
